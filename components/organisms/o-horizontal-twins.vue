...
// copied styling of sf-banner class from storefront ui
.sf-banner {
...
//  copied styling of sf-banner-grid from storefront ui
.sf-banner-grid {
...
// commented this as we are using the storefront ui css directly in the components
// .sf-banner-grid {
//   --banner-container-width: 50%;
//   &__row {
//     & + & {
